...
export default class Sprite10 extends Sprite {
  ...
  *whenIReceiveShop() {
    ...
    while (true) {
      if (
        this.stage.vars.Highscore == 20 ||
        this.stage.vars.Highscore > 20 ||
        0
      ) {
        if (this.stage.vars.OfSkinsUnlocked < 1) {
          this.stage.vars.OfSkinsUnlocked = 1;
        }
        if (this.stage.vars.Skin == 2) {
  ...
  *whenthisspriteclicked() {
    if (this.stage.vars.Highscore == 20 || this.stage.vars.Highscore > 20) {
      this.costume = "costume1";
      this.stage.vars.Skin = 2;
    } else {
      null;
    }
  }
